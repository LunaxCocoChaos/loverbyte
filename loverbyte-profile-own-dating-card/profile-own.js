(() => {
  ...
  const applyProfileSnapshot = () => {
    ...
    if (profileStats) {
      ...
      const following = numberFormatter.format(Number.isFinite(Number(snapshot.followingCount)) ? Number(snapshot.followingCount) : 2734);
